      ...
      <div class="media">
        ...
        <div class="media-body ml-4">
          ...
          <div class="countdown-times">
            <h6 class="my-2">Transaction N0: ${i + 1}</h6>
 ...
 <div class="contract-user-profile">
     <img src="assets/img/content/team_1.png" alt=""/>
        <div class="contract-user-profile-info">
          ...
          <span class="contract-space"><strong>StakeAmount:&nbsp;</strong>
          ${User.stakeAmount / 10 ** 18 }</span>

          <span class="contract-space"><strong>LastRewardCalculationTime:&nbsp;</strong>
          ${generateCountDown(User.lastRewardCalculationTime)}</span>
                    
          <span class="contract-space"><strong>LastStakeTime:&nbsp;</strong>
          ${generateCountDown(User.lastStakeTime)}</span>

          <span class="contract-space"><strong>RewardAmount:&nbsp;</strong>
          ${User.rewardAmount / 10 ** 18} </span>
                    
          <span class="contract-space"><strong>RewardsClaimedSoFar:&nbsp;</strong>
          ${User.rewardsClaimedSoFar / 10 ** 18} </span>
                    
          <p class="contract-paragraph">
                      This is the Token Stacking Platform that allows you to stack the TBC token 
                      and earn rewards
          </p>
      </div>
    </div> 
